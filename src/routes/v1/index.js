...
const approvalsRoutes = require('./approvals/index');
...
router.use('/approvals', authMiddleware, approvalsRoutes);
router.use('/company-admin', authMiddleware, companyAdminMiddleware, companyadmin);
