const { employeeCheckIn, employeeCheckOut, isCheckedIn, missedOutNotification, getAttandanceData, createRegularizeRequest, getEmpRegReq } = require('../../../controllers/ESSController');
...
router.get('/regularizations', getEmpRegReq);
